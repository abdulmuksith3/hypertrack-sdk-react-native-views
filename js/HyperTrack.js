...
class HyperTrackAPI {
  ...
  getDeviceMovementStatus(deviceID: string): Promise<Object> {
    return HyperTrack.getDeviceMovementStatus(deviceID);
  }
  /**
   ...
   * @param {Object} component - Instance of your component.
   */
  unregisterDeviceUpdatesListeners(component: Object) {
